...
if($id_virtualtour==0) {
    ...
    $mysqli->query("UPDATE svt_virtualtour_tmp SET id=(SELECT MAX(id)+1 as id FROM svt_virtualtours),id_user=$id_user,name='$name',date_created=NOW(),ga_tracking_id=NULL,friendly_url=NULL;");
