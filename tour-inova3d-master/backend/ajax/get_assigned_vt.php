...
$columns = array(
    ...
    array( 'db' => 'publish',  'dt' =>22, 'formatter' => function( $d, $row ) {
        if(empty($d)) $d=0;
        if($d==1) {
    ...
    array( 'db' => 'landing',  'dt' =>23, 'formatter' => function( $d, $row ) {
        if(empty($d)) $d=0;
        if($d==1) {
    ...
    array( 'db' => 'forms',  'dt' =>24, 'formatter' => function( $d, $row ) {
        if(empty($d)) $d=0;
        if($d==1) {
    ...
    array( 'db' => 'leads',  'dt' =>25, 'formatter' => function( $d, $row ) {
        if(empty($d)) $d=0;
        if($d==1) {
    ...
    array( 'db' => 'shop',  'dt' =>26, 'formatter' => function( $d, $row ) {
        if(empty($d)) $d=0;
        if($d==1) {
    ...
    array( 'db' => 'edit_3d_view',  'dt' =>27, 'formatter' => function( $d, $row ) {
        if(empty($d)) $d=0;
        if($d==1) {
