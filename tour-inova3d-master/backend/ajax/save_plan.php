...
$query = "UPDATE svt_plans SET name='$name', n_virtual_tours=$n_virtual_tours ,n_rooms=$n_rooms, n_markers=$n_markers, n_pois=$n_pois, days=$days, create_landing=$create_landing, create_gallery=$create_gallery, create_presentation=$create_presentation, enable_live_session=$enable_live_session, price=$price, currency='$currency',custom_features='$custom_features', max_file_size_upload=$max_file_size_upload, max_storage_space=$max_storace_space, enable_chat=$enable_chat, enable_voice_commands=$enable_voice_commands, enable_share=$enable_share, enable_device_orientation=$enable_device_orientation, enable_webvr=$enable_webvr, enable_logo=$enable_logo, enable_nadir_logo=$enable_nadir_logo, enable_song=$enable_song, enable_forms=$enable_forms, enable_annotations=$enable_annotations, enable_panorama_video=$enable_panorama_video, enable_rooms_multiple=$enable_rooms_multiple, enable_rooms_protect=$enable_rooms_protect, enable_info_box=$enable_info_box, enable_context_info=$enable_context_info, enable_maps=$enable_maps, enable_icons_library=$enable_icons_library, enable_password_tour=$enable_password_tour, enable_expiring_dates=$enable_expiring_dates, enable_statistics=$enable_statistics, enable_auto_rotate=$enable_auto_rotate, enable_flyin=$enable_flyin, enable_multires=$enable_multires, enable_meeting=$enable_meeting, create_showcase=$create_showcase, enable_export_vt=$enable_export_vt,enable_shop=$enable_shop,enable_dollhouse=$enable_dollhouse,visible=$visible,external_url='$external_url',frequency='$frequency',interval_count=$interval_count,customize_menu='$customize_menu' WHERE id=$id;";
