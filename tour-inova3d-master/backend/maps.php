...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-map-marked-alt text-gray-700"></i> <?php echo _("MAPS"); ?></h1>
            ...
            <div class="card-body" style="padding-top: 0;padding-bottom: 0;">
                <div class="row">
                    ...
                    <div class="col-md-4 text-center text-sm-center text-md-right text-lg-right">
                        ...
                        <a href="index.php?p=maps_bulk" class="btn btn-success">
                            <?php echo _("BULK"); ?>
                        </a>
                    </div>
                </div>
...
<div id="modal_delete_map" class="modal" tabindex="-1" role="dialog" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><?php echo _("Are you sure you want to delete the entire map and all the points?"); ?></p>
            </div>
            <div class="modal-footer">
