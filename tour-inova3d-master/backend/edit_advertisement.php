...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-ad text-gray-700"></i> <?php echo _("EDIT ADVERTISEMENT"); ?></h1>
    <div>
        <button <?php echo ($demo) ? 'disabled':''; ?> onclick="modal_delete_advertisement(<?php echo $id_advertisement; ?>);" class="btn btn-sm btn-danger mb-2 ml-3 float-right"><?php echo _("DELETE"); ?></button>
        <a id="save_btn" href="#" onclick="save_advertisement(<?php echo $id_advertisement; ?>);return false;" class="btn btn-sm btn-success btn-icon-split mb-2 <?php echo ($demo) ? 'disabled':''; ?>">
