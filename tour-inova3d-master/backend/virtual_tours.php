...
<div id="modal_export_virtualtour" class="modal" tabindex="-1" role="dialog" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button <?php echo (($_SERVER['SERVER_ADDR']=='5.9.29.89') && ($_SERVER['REMOTE_ADDR']!=$_SESSION['ip_developer'])) ? 'disabled':''; ?> id="btn_export_virtualtour" onclick="" type="button" class="btn btn-success"><i class="fas fa-download"></i> <?php echo _("Standalone"); ?></button>
                <?php if($user_role=='administrator') : ?>
                    <button <?php echo (($_SERVER['SERVER_ADDR']=='5.9.29.89') && ($_SERVER['REMOTE_ADDR']!=$_SESSION['ip_developer'])) ? 'disabled':''; ?> id="btn_export_virtualtour_b" onclick="" type="button" class="btn btn-primary"><i class="fas fa-download"></i> <?php echo _("Importable"); ?></button>
                <?php endif; ?>
                <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-times"></i> <?php echo _("Close"); ?></button>
            </div>
        </div>
...
<div id="modal_import_tour" class="modal" tabindex="-1" role="dialog" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button <?php echo (($_SERVER['SERVER_ADDR']=='5.9.29.89') && ($_SERVER['REMOTE_ADDR']!=$_SESSION['ip_developer'])) ? 'disabled':''; ?> id="btn_import_tour" onclick="" type="button" class="btn btn-success disabled"><i class="fas fa-file-import"></i> <?php echo _("Import"); ?></button>
            ...
            ajax.addEventListener('load',function(evt){
                ...
                if(evt.target.responseText.toLowerCase().indexOf('error')>=0){
                    ...
                    if(evt.target.responseText!='') {
                        $('#btn_import_tour').attr('onclick','import_tour("'+evt.target.responseText+'");');
                    }
                }
