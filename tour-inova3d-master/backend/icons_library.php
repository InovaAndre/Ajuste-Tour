...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-icons text-gray-700"></i> <?php echo _("ICONS LIBRARY"); ?></h1>
...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="ajax/upload_icon_image.php" class="dropzone mb-3 noselect <?php echo ($demo || $disabled_upload) ? 'disabled' : ''; ?>" id="icons-dropzone"></form>
