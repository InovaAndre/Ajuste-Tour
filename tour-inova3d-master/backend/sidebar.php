...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item <?php echo $statistics_active; ?> <?php echo $statistics_visible; ?>">
    ...
    <li class="nav-item <?php echo $collapse_vt_active; ?> <?php echo $virtual_tours_visible; ?>">
        ...
        <div id="collapse_vt" class="collapse <?php echo $collapse_vt_show; ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item <?php echo $vt_disabled; ?> <?php echo $pois_active; ?> <?php echo $pois_visible; ?>" href="index.php?p=pois"><i class="fas fa-fw fa-bullseye"></i> <span><?php echo _("POIs"); ?></span></a>
    ...
    <li class="nav-item <?php echo $collapse_publish_active; ?> <?php echo $publish_visible; ?>">
        ...
        <div id="collapse_publish" class="collapse <?php echo $collapse_publish_show; ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar" style="">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item <?php echo $vt_disabled; ?> <?php echo $publish_active; ?> <?php echo $links_visible; ?>" href="index.php?p=publish"><i class="fas fa-fw fa-link"></i> <span><?php echo _("Links"); ?></span></a>
    ...
    <li class="nav-item <?php echo $collapse_data_active; ?> <?php echo $publish_visible; ?>">
