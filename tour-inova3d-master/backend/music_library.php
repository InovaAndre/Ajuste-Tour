...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-music text-gray-700"></i> <?php echo _("MUSIC LIBRARY"); ?></h1>
...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="ajax/upload_music_library_file.php" class="dropzone mb-3 noselect <?php echo ($demo || $disabled_upload) ? 'disabled' : ''; ?>" id="music-dropzone"></form>
                <div id="list_files">
